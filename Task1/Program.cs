...
if (A == 7) Console.WriteLine("Это ВЫХОДНОЙ!!! "); 

if (A < 1) Console.WriteLine("Вы ввели число меньше 1, пожалуйста введите число от 1 до 7");
if (A > 7) Console.WriteLine("Вы ввели число больше 7, пожалуйста введите число от 1 до 7");
